...
function GameController(playerOneObj, playerTwoObj) {
  // create a board
  ...
  const checkGameOver = function () {
    ...
    if (
      Number.isInteger(winCondition.row) ||
...
const playerModule = {
  ...
  bindEvents: function () {
    ...
    this.playerOneBtn.addEventListener("click", this.setPlayerOne.bind(this));
    this.playerTwoBtn.addEventListener("click", this.setPlayerTwo.bind(this));
    this.playerNilBtn.addEventListener("click", this.unsetOrder.bind(this));
  },
  render: function () {},
  ...
  setPlayerOrder: function (event) {
    ...
    let playerIndex =
      event.target.parentElement.parentElement.dataset.playerIndex;
...
const gameModule = {
  ...
  makeMove: function (event) {
    // change to (event) when linked to DOM
